...
model = init_chat_model("ollama:mistral", temperature=0.5, timeout=300, max_tokens=25000)
...
URL: https://www.gutenberg.org/files/64317/64317-0.tx
...
agent_result = agent.invoke(
    ...
    config={"configurable":{"thread_id": "great_gatsby_analysis_lc"}}
